                ...
                ProcessModules = new ModuleList
                {
                    ...
                    new StartProcess("dotnet")
                        ...
                        .WithArgument(Config.FromContext(context => context.GetBool(BuildServer)
                            ...
                            : null))
                        .WithArgument(Config.FromContext(context => context.GetBool(BuildServer)
                            ? "-p:StatiqWebVersion=\"local\"" // Use a local version of Statiq.Web when building on CI
                            : null))
